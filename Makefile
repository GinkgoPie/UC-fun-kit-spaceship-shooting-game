...
game.o: game.c ../../drivers/avr/pio.h ../../drivers/avr/system.h ../../utils/pacer.h ../../drivers/ledmat.h
	$(CC) -c $(CFLAGS) $< -o $@
...
game.out: game.o pio.o system.o pacer.o timer.o ledmat.o tinygl.o display.o font.o task.o navswitch.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
